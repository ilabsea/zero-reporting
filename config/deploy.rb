...
set :linked_files, fetch(:linked_files, []).push('config/application.yml', 'config/secrets.yml', 'config/database.yml', 'config/step_manifest.xml', 'config/aws.yml', 'config/smtp.yml', 'config/sidekiq-main.yml', 'config/settings.yml', 'config/elasticsearch.yml')
