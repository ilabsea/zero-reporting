...
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      loop: false,
      preload: true,
      imageLocation: '/assets/audiojs-player-graphics-78f5690beffde32596eafa49fe27d1ef.gif',
      swfLocation: '/assets/audiojs-fb1bc948037d4b4cb1e94795a371274f.swf',
      useFlash: (function() {
...
function redirectTo(url){
  setNotification("Notice", "Page is being redirected")
  window.location.href = url
}
;
$(function(){
